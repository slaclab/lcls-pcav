...
for shot=1:Nshots
    domega = polyfit(fitrange',angle(DDC1(fitrange,shot)),1);
    deltaF1(shot)=domega(1)*119e6/2/pi;
    domega = polyfit(fitrange',angle(DDC2(fitrange,shot)),1);
    deltaF2(shot)=domega(1)*119e6/2/pi;
    domega = polyfit(fitrange',angle(DDC3(fitrange,shot)),1);
    deltaF3(shot)=domega(1)*119e6/2/pi;
    domega = polyfit(fitrange',angle(DDC4(fitrange,shot)),1);

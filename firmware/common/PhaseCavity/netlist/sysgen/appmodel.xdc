set rateCedsp12 appmodel_default_clock_driver/clockdriver_x1/pipelined_ce.ce_pipeline[1].ce_reg/latency_gt_0.fd_array[1].reg_comp/fd_prim_array[0].bit_is_0.fdre_comp
set rateCellsdsp12 [get_cells -of [filter [all_fanout -flat -endpoints [get_pins $rateCedsp12/Q]] IS_ENABLE]]
set rateCeaxi_lite8 appmodel_default_clock_driver/clockdriver/pipelined_ce.ce_pipeline[1].ce_reg/latency_gt_0.fd_array[1].reg_comp/fd_prim_array[0].bit_is_0.fdre_comp
